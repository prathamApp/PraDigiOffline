...
public class FsService extends Service implements Runnable {
    ...
    static public final String ACTION_STARTED = "mayurmhm.mayur.ftpmodule.FTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "mayurmhm.mayur.ftpmodule.FTPSERVER_STOPPED";
    static public final String ACTION_FAILEDTOSTART = "mayurmhm.mayur.ftpmodule.FTPSERVER_FAILEDTOSTART";

    // RequestStartStopReceiver listens for these actions to start/stop this server
    static public final String ACTION_START_FTPSERVER = "mayurmhm.mayur.ftpmodule.ACTION_START_FTPSERVER";
    static public final String ACTION_STOP_FTPSERVER = "mayurmhm.mayur.ftpmodule.ACTION_STOP_FTPSERVER";
...
//                    continue;
    ...
    public static boolean isConnectedToLocalNetwork() {
        ...
        Context context = PrathamApplication.getAppContext();
